...
const Header = () => {
  ...
  const cupColor = useSelector((store) => store.page.cupColor);
  ...
  return (
    <div className="top-0 left-0 m-0 h-28 lg:h-16 w-screen flex justify-between bg-[--headerBg] border-b-[2px] border-[--border-color]">
      ...
      <div className="ml-0 p-4 h-28 lg:h-16 flex items-center z-50">
        <div className="relative m-0 p-0 w-20">
          <Link to={"/rules"}>
            <svg
              ...
              fill="currentColor"
            >
              <path d="M6 2h9l5 5v13c0 1.1-.9 2-2 2H6c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2zm7 7V3.5L18.5 9H13zm-1 2H8v2h4v-2zm0 4H8v2h4v-2z" />
            </svg>
          </Link>
        </div>
